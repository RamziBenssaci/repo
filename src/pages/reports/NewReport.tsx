...
const reportTypes = [
  { value: 'infection', label: 'عدوى مكتسبة من المستشفى' },
  { value: 'medication', label: 'خطأ دوائي' },
  { value: 'fall', label: 'سقوط مريض' },
  { value: 'equipment', label: 'عطل في المعدات' },
  { value: 'procedure', label: 'خطأ في الإجراء' },
