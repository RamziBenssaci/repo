...
import { directPurchaseApi } from '@/lib/api';
            ...
            <div>
              ...
              <Select value={facilityFilter} onValueChange={setFacilityFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="مستشفى الملك فهد">مستشفى الملك فهد</SelectItem>
                  <SelectItem value="مركز الأورام">مركز الأورام</SelectItem>
                  <SelectItem value="مركز القلب">مركز القلب</SelectItem>
                  <SelectItem value="مركز الأطفال">مركز الأطفال</SelectItem>
                  <SelectItem value="العيادات الخارجية">العيادات الخارجية</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Select value={supplierFilter} onValueChange={setSupplierFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="شركة التقنية الطبية">شركة التقنية الطبية</SelectItem>
                  <SelectItem value="مؤسسة الأجهزة المتقدمة">مؤسسة الأجهزة المتقدمة</SelectItem>
                  <SelectItem value="شركة الحلول الصحية">شركة الحلول الصحية</SelectItem>
                </SelectContent>
              </Select>
            </div>
