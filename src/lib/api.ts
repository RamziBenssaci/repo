...
export const authApi = {
  ...
  adminLogout: async (): Promise<ApiResponse> => {
    return apiCall<ApiResponse>('/admin/logout', {
      method: 'POST',
    }, true, 'admin');
  },
  ...
  staffLogout: async (): Promise<ApiResponse> => {
    return apiCall<ApiResponse>('/staff/logout', {
      method: 'POST',
    }, true, 'staff');
  },
};
...
export const directPurchaseApi = {
  ...
  getOrders: () => apiCall('/direct-purchase/orders', {}, true, 'staff'),

  // Get specific direct purchase order
  getOrder: (id: string) => apiCall(`/direct-purchase/orders/${id}`, {}, true, 'staff'),
  ...
  getReports: (params?: { type?: string; status?: string; facility?: string; supplier?: string; item?: string }) => {
    ...
    return apiCall(`/direct-purchase/reports${queryString ? `?${queryString}` : ''}`, {}, true, 'staff');
  },
  ...
  getDashboardData: (params?: { facility?: string; item?: string; supplier?: string }) => {
    ...
    const queryString = searchParams.toString();
    return apiCall(`/direct-purchase/dashboard${queryString ? `?${queryString}` : ''}`, {}, true, 'staff');
  }
};
...
export const dashboardApi = {
  ...
  // Get facilities list
  getFacilities: () => apiCall('/facilities'),
  ...
  // Get recent reports
  getRecentReports: () => apiCall('/dashboard/recent-reports')
};
